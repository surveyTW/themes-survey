...
<div><a href="<?php print $base_url;?>"><img src="<?php print $base_url?>/sites/all/themes/survey/logo.png"></a></div>
    <div style="min-width:220px;max-width:440px;margin:0 auto;padding-top:6px;text-align:left;font-family:arial,sans-serif;color:#A07D5B">
        ...
        <div>親愛的會員您好</div>
        <div><br></div>
        <div style="margin-bottom:10px"><?php print $params['name'];?>已經結束"<a href="<?php print $params['survey_url']?>"><?php print $params['title']?></a>"聚會調查</div>
        <div style="margin-bottom:10px">歡迎前往<a href="<?php print $base_url?>">EZMEET</a>查看詳細內容並且同步活動到您的行事曆中！</div>
        <div><br></div>
        <div style="width:100%;height:1px; background:#E0E0E0;"></div>
