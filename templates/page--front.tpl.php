  ...
  <div class="row">
    ...
    <div class="container slogon">
        <div class="row no-gutter">
            ...
            <div class="col-sm-6 text-center demo1"><h3>流程設計簡單 運用方便好上手</h3></div>
            <div class="col-sm-7 demo2"><h3>意見收集省時 開心等結果</h3></div>
            <div class="col-sm-5"><img src="sites/all/themes/survey/img/homesm1.jpg"></div>
            <div class="col-sm-5"><img src="sites/all/themes/survey/img/homesm1.jpg"></div>
            <div class="col-sm-7 demo3"><h3>多人一起約 輕鬆不麻煩</h3></div>
            <div class="col-sm-4"><img src="sites/all/themes/survey/img/homesm1.jpg"></div>
            <div class="col-sm-4 demo4"><h3>聚會易管理 Easy Meet</h3></div>
            <div class="col-sm-4"><img src="sites/all/themes/survey/img/homesm1.jpg"></div>
        </div>
    </div>
...
<footer class="footer container">
  ...
  <p class="text-center"><a href="#">EZMEET粉絲團</a> | 繁體中文</p>
